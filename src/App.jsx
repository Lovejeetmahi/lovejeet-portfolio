...
const AshSystem = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-[49]">
      {ashes.map((_, i) => {
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen scroll-smooth transition-colors duration-700 ${isDark ? 'bg-[#050505]' : 'bg-slate-50'}`}>
      ...
      <div className="plasma top-[-10%] left-[-5%] animate-pulse opacity-30" />
      <div className="plasma bottom-[-10%] right-[-5%] opacity-20" />
      ...
      <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] w-[95%] max-w-7xl glass rounded-full px-6 md:px-10 h-20 flex items-center justify-between shadow-2xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="/Lovejeet_Mahi_Resume.pdf" download className="hidden sm:block px-6 py-2 bg-red-600 text-white rounded-full text-[10px] font-black tracking-widest uppercase hover:bg-red-700 transition">Resume</a>
        </div>
      </nav>
      ...
      <section id="home" className="relative pt-64 pb-20 px-6 flex flex-col items-center text-center z-10">
        ...
        <p className="max-w-xl text-lg font-bold dark:text-slate-400 text-slate-600">
          Full-Stack Architect specialized in digital ecosystems, currently at <span className="text-red-600">LPU</span>.
        </p>
      </section>
